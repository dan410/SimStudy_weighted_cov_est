...
### Grid 1 data
d1 <- readRDS("Data/dat_grid_1_sig_0.01_dep_0.rds")
d2 <- readRDS("Data/dat_grid_1_sig_0.01_dep_0.1.rds")
d3 <- readRDS("Data/dat_grid_1_sig_0.01_dep_0.2.rds")
d4 <- readRDS("Data/dat_grid_1_sig_0.01_dep_0.3.rds")
d5 <- readRDS("Data/dat_grid_1_sig_0.01_dep_0.4.rds")

d6 <- readRDS("Data/dat_grid_1_sig_0.3_dep_0.rds")
d7 <- readRDS("Data/dat_grid_1_sig_0.3_dep_0.1.rds")
d8 <- readRDS("Data/dat_grid_1_sig_0.3_dep_0.2.rds")
d9 <- readRDS("Data/dat_grid_1_sig_0.3_dep_0.3.rds")
d10 <- readRDS("Data/dat_grid_1_sig_0.3_dep_0.4.rds")

GRID1 <- c(d1, d2, d3, d4, d5)
saveRDS(GRID1, "Data/GRID1.rds")
